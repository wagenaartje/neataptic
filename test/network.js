...
function testEquality(original, copied){
  for(var j = 0; j < 50; j++){
    var input = [];
    for(var a = 0; a < original.input; a++){
...
describe('Networks', function () {
  ...
  describe("Structure", function(){
    ...
    it("from/toJSON equivalency", function(){
      ...
      var original = new Architect.GRU(Math.floor(Math.random() * 5 + 1), Math.floor(Math.random() * 5 + 1), Math.floor(Math.random() * 5 + 1), Math.floor(Math.random() * 5 + 1));
      var copy = Network.fromJSON(original.toJSON());
      testEquality(original, copy);

      var original = new Architect.Random(Math.floor(Math.random() * 5 + 1), Math.floor(Math.random() * 10 + 1), Math.floor(Math.random() * 5 + 1));
      var copy = Network.fromJSON(original.toJSON());
      testEquality(original, copy);

      var original = new Architect.NARX(Math.floor(Math.random() * 5 + 1), Math.floor(Math.random() * 10 + 1), Math.floor(Math.random() * 5 + 1), Math.floor(Math.random() * 5 + 1), Math.floor(Math.random() * 5 + 1));
      var copy = Network.fromJSON(original.toJSON());
      testEquality(original, copy);

      var original = new Architect.Hopfield(Math.floor(Math.random() * 5 + 1));
      var copy = Network.fromJSON(original.toJSON());
      testEquality(original, copy);
    });
    it("standalone equivalency", function(){
      ...
      var original = new Architect.NARX(Math.floor(Math.random() * 5 + 1), Math.floor(Math.random() * 5 + 1), Math.floor(Math.random() * 5 + 1), Math.floor(Math.random() * 5 + 1), Math.floor(Math.random() * 5 + 1));
      eval(original.standalone());
      testEquality(original, activate);
