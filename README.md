...
Neataptic trains 10x faster than competitors. [Run the tests yourself](https://jsfiddle.net/tuet004f/10/).
...
```html
<script src="https://wagenaartje.github.io/neataptic/cdn/1.2.22/neataptic.js"></script>
```
